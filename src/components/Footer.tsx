    ...
    <footer className="bg-[#05070d] border-t border-slate-900 py-12 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex flex-col text-left space-y-1">
              <div className="flex items-center space-x-2">
                ...
                <span className="px-1.5 py-0.2 rounded-md bg-cyan-500/20 text-cyan-300 border border-cyan-400/40 text-[10px] font-mono font-bold">
                  "SJ"
                </span>
              </div>
              <p className="text-xs text-slate-400 font-mono">
                B.Tech AI & Data Science Graduate • <span className="text-cyan-300 italic">"Better call me SJ"</span>
              </p>
              <div className="flex items-center space-x-1.5 text-[11px] text-slate-500 font-mono pt-0.5">
        ...
        <div className="mt-8 pt-8 border-t border-slate-900/80 text-center text-xs font-mono text-slate-500 flex flex-col sm:flex-row justify-between items-center gap-2">
          <span>© {new Date().getFullYear()} Sanjay Saminathan ("SJ"). All rights reserved.</span>
